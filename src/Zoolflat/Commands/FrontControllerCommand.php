...
use Zoolflat\Zoolflat\Zoolflat\Traits\ControllerRelationTrait;
use Zoolflat\Zoolflat\Zoolflat\Traits\ControllerTrait;
use Zoolflat\Zoolflat\Zoolflat\Traits\Upload;
...
class FrontControllerCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Zoolflat:front_controller {module}';
