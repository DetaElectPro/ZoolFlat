...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Zoolflat:install';
     ...
     * @var string
     */
    protected $description = 'Install Zoolflat';
    ...
    public function handle()
    {
        ...
        $this->filesystem->put(
            fixPath(base_path('config/Zoolflat.php'))
    ...
    */
    ...
    {
        return __DIR__ . '/../../stubs/config/Zoolflat.stub';
    }
