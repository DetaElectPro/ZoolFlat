...
use Zoolflat\Zoolflat\Zoolflat\Traits\ModelRelationTrait;
use Zoolflat\Zoolflat\Zoolflat\Traits\ModelTrait;
use Zoolflat\Zoolflat\Zoolflat\Traits\MultiValueHandel;
...
class ModelCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Zoolflat:model {module}';
