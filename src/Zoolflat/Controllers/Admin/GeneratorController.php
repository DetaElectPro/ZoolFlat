...
use Zoolflat\Zoolflat\Zoolflat\Models\Relation;
use Zoolflat\Zoolflat\Zoolflat\Traits\GeneratorTrait;
use Zoolflat\Zoolflat\Zoolflat\Traits\SeedsTrait;
...
class GeneratorController extends Controller
{
    ...
    {
        Artisan::call('Zoolflat:api_request', ['module' => $module->name]);
    }
    ...
    */
    ...
    {
        Artisan::call('Zoolflat:api_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:route_front', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:route_api', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:api_resource', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:lang', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:seeder', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:config', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:front_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:admin_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_front_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_admin_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:front_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:admin_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_front_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_admin_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_front_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:view_admin_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:migration', ['module' => $module->name]);
    }
   ...
   */
    ...
    {
        Artisan::call('Zoolflat:provider', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:route_admin', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('Zoolflat:model', ['module' => $module->name]);
    }
