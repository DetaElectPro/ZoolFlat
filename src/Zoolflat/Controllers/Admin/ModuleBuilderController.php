...
use Zoolflat\Zoolflat\Zoolflat\Models\Column;
use Zoolflat\Zoolflat\Zoolflat\Models\ColumnDetail;
use Zoolflat\Zoolflat\Zoolflat\Models\Module;
use Zoolflat\Zoolflat\Zoolflat\Models\Relation;
use Zoolflat\Zoolflat\Zoolflat\Requests\StepFourRequest;
use Zoolflat\Zoolflat\Zoolflat\Requests\StepOneRequest;
use Zoolflat\Zoolflat\Zoolflat\Requests\StepTwoRequest;
use Zoolflat\Zoolflat\Zoolflat\Traits\TypesTrait;
...
class ModuleBuilderController extends Controller
{
    ...
    public function index(Module $modules)
    {
        ...
        */
        ...
        return view('Zoolflat::admin.generator.index', compact('modules'));
    }
    ...
    public function stepOneView($id = null, Module $module)
    {
        ...
        return view('Zoolflat::admin.generator.steps.step-one.index', compact(
            'module'
        ));
    }
    ...
    public function stepTwoView($id, Module $module)
    {
       ...
       */
        ...
        return view('Zoolflat::admin.generator.steps.step-two.index', compact(
            'module',
            'migrationTypes',
            'migrationModifiers'
        ));
    ...
    public function stepThreeView($id, Module $module)
    {
        ...
        return view('Zoolflat::admin.generator.steps.step-three.index', compact(
            'module',
            'htmlInputType',
            'validationRules'
        ));
    ...
    */
    ...
    public function stepFourView($id, Module $module , Relation $relation)
    {
       ...
       */
        ...
        return view('Zoolflat::admin.generator.steps.step-four.index', compact(
            'module',
            'relationType',
            'modules',
            'relations',
    ...
    public function stepFiveView($id ,Module $module)
    {
        ...
        return view('Zoolflat::admin.generator.steps.step-five.index', compact(
            'module',
            'arrays',
            'languages'
        ));
