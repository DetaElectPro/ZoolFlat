...
@section('content')
    ...
    <section class="content">
        <div class="callout callout-info">
            <h4>@lang('zoolflat::zoolflat.Modules')!</h4>
            <p>@lang('zoolflat::zoolflat.Modules Description')</p>
        </div>
        <!-- Default box -->
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">@lang('zoolflat::zoolflat.Modules')</h3>
            ...
            <div class="box-body">
                <table class="table table-responsive table-bordered ">
                    <tr >
                        ...
                        <th align="center">
                            @lang('zoolflat::zoolflat.Setting')
                        </th>
                        <th align="center">
                            @lang('zoolflat::zoolflat.Migration')
                        </th>
                        <th align="center">
                            @lang('zoolflat::zoolflat.Validation')
                        </th>
                        <th align="center">
                            @lang('zoolflat::zoolflat.Relations')
                        </th>
                        <th align="center">
                            @lang('zoolflat::zoolflat.Translation')
                        </th>
                    </tr>
